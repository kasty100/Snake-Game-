...
//	        g.drawString("Player Name: " + playerName, 10, 20);
		//playerName draws
	...
	public void draw(Graphics g) {
		...
		if(running) {
			...
			*/
			g.setColor(new Color(201, 22, 22));
	...
	public void gameOver(Graphics g) {
		...
		g.drawString(" Nikal Lavde😒", (SCREEN_WIDTH - metrics2.stringWidth("Game Over"))/2, SCREEN_HEIGHT/2);
		
		//playerName
		g.setColor(new Color(242, 216, 189));
		g.setFont( new Font("Sans serif",Font.ROMAN_BASELINE, 55));
		FontMetrics metrics3 = getFontMetrics(g.getFont());
		g.drawString(playerName, 310, 400);
